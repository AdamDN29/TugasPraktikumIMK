...
public class Movement : MonoBehaviour
{
    ...
    public void FixedUpdate()
    {
        ...
        if (_controls.Player.Dance.IsPressed() && flag == 1)
        {
        ...
        else if (_controls.Player.Dance.IsPressed() && flag == 2)
        {
    ...
    private void IdleAnimation()
    {
        ...
        if (whenIdle >= 5f && !_controls.Player.Jump.IsPressed() && !_controls.Player.Move.IsPressed())
        {
